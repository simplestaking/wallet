import {
  ...
  import { reduceTicks } from '@swimlane/ngx-charts/release/common/axes/ticks.helper';
  ...
  export class XAxisTicksNavComponent implements OnChanges, AfterViewInit {
    ...
    verticalSpacing: number = 20; // 20;
    rotateLabels: boolean = false;
    innerTickSize: number = 6 // 6;
