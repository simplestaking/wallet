...
import * as fromTezosFileCreate from './tezos-file/tezos-file-create/tezos-file-create.reducer';
...
import * as fromTezosWalletNewMnemonic from './tezos-wallet/tezos-wallet-new/tezos-wallet-new-mnemonic/tezos-wallet-new-mnemonic.reducer'
...
import * as fromTezosOperationMnemonic from './tezos-operation/tezos-operation-mnemonic/tezos-operation-mnemonic.reducer';
...
export const reducers: ActionReducerMap<State> = {
    ...
    tezosFileCreate: fromTezosFileCreate.reducer,
    ...
    tezosWalletNewMnemonic: fromTezosWalletNewMnemonic.reducer,
    ...
    tezosOperationMnemonic: fromTezosOperationMnemonic.reducer,
